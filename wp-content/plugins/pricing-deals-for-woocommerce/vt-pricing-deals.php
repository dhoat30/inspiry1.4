...
class VTPRD_Controller{
    ...
    //v2.0.2.02 end
		...
		define('VTPRD_VERSION',                           '2.0.2.02');
    define('VTPRD_MINIMUM_PRO_VERSION',                   '2.0.2.02'); 
    define('VTPRD_LAST_UPDATE_DATE',                      '2021-02-07');
    ...
    define('VTPRD_ADMIN_CSS_FILE_VERSION',                'v006.min'); //v2.0.2.02 new version  ==> use to FORCE pickup of new CSS
