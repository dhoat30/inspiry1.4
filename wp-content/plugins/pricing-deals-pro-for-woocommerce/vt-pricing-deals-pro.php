...
class VTPRD_Pro_Controller{
    ...
    define('VTPRD_PRO_VERSION',                           '2.0.2.02');  //in the FREE version, current required version remains 1.1.2 ...     
    define('VTPRD_PRO_MINIMUM_REQUIRED_FREE_VERSION',     '2.0.2.02');  //required version of
    define('VTPRD_PRO_LAST_UPDATE_DATE',                  '2021-02-07');
 ...
 */   
   ...
   /* not necessary, done before function exec...    
    ...
    //v2.0.2.0 
    /*  added purchaser_user_id bigint(20),
