...
<div class="body max-width padding">
        ...
        <?php 
            ...
            <!-- tracking number -->
            <p class="paragraph">Thanks for your order,<br>
            This is to inform you that this item is not available in our stocks, apologize for any inconvenience caused.<br><br>
            Can you please provide us your bank details we can make a refund for you.<br><br>
