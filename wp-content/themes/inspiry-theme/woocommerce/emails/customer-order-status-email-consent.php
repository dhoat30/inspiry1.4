...
<div class="body max-width padding">
        ...
        <?php 
            ...
            <!-- tracking number -->
            <p class="paragraph">Hope you are doing well, <br><br>This is to inform you that your order will be available on <strong> <?php echo $date->format('d-m-Y');?></strong>, we will keep it in backorder.  Apologize for the delay of stocks because of the current situation. Once this has been shipped we will send you the Tracking Number. And hope this is suitable to you.<br>
                <br>Your support and trust in us are much appreciated,<br><br>
                We are here for any inquiry, do not hesitate to contact us.</p>
