...
<div class="yith-wcwl-share">
	...
	<?php if ( $share_url_enabled ) : ?>
		<div class="yith-wcwl-after-share-section">
			...
			<?php echo ( ! empty( $share_link_url ) ) ? sprintf( '<small>%s <span class="copy-trigger">%s</span> %s</small>', esc_html__( '', 'yith-woocommerce-wishlist' ), esc_html__( 'Copy Link', 'yith-woocommerce-wishlist' ), esc_html__( '', 'yith-woocommerce-wishlist' ) ) : ''; ?>
		</div>
	<?php endif; ?>
