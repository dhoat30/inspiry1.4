...
require get_theme_file_path('/inc/webduel-short-code.php');
 ...
 function inspiry_scripts(){ 
   ...
   if (strstr($_SERVER['SERVER_NAME'], 'localhost')) {
      ...
      wp_enqueue_script('main', get_theme_file_uri('/bundled-assets/scripts.332698fcc62113465646.js'), NULL, '1.0', true);
      wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.332698fcc62113465646.css'));      
      wp_enqueue_style('our-vendor-styles', get_theme_file_uri('/bundled-assets/styles.332698fcc62113465646.css'));
    }
